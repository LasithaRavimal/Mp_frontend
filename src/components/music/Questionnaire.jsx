...
<div key={i} className="bg-white border border-slate-200 rounded-lg shadow-sm p-6 mb-6">
...
<label
key={opt.value}
className="flex items-center gap-2 border border-slate-200 p-3 rounded-lg cursor-pointer hover:bg-slate-50"
>
...
<h2 className="text-xl font-semibold mt-8 mb-4 text-slate-700">
DASS-21 Stress
</h2>
...
className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg font-semibold mt-6"
>
...
<p className="mt-4">
Stress Score: {result.stressScore}
</p>
